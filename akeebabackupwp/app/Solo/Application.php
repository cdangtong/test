...
// Load the routes from JSON, if they are present
	...
	public function dispatch()
	{
		...
		/**
		 * Activate Selectize drop-downs.
		 *
		 * @see https://github.com/selectize/selectize.js/blob/master/examples/optgroups.html
		 */
		$this->container->application->getDocument()->addScriptDeclaration( <<<JS
Solo.loadScripts.push(function() {
    akeeba.jQuery('select.akeeba_selectize').selectize({
        sortField: 'text'
    });
});
