...
if (version_compare(PHP_VERSION, '5.5.0', 'lt')):
	$akeebaCommonDatePHP = new \Awf\Date\Date('2015-09-03 00:00:00', 'GMT');
	$akeebaCommonDateObsolescence = new \Awf\Date\Date('2016-06-03 00:00:00', 'GMT');
	?>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<p>
					...
					<button class="btn btn-xs btn-info <?php echo (strlen(Text::_('SOLO_APP_TITLE')) > 14) ? '' : 'pull-right' ?>"
                    onclick="Solo.Modal.open({inherit: '#changelogModal', width: '80%'}); return false;">
                        Changelog
                    </button>
				</p>
