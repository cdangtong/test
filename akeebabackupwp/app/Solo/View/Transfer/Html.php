...
Solo.loadScripts.push(function() {
    ...
    Solo.Transfer.translations['COM_AKEEBA_FILEFILTERS_LABEL_UIROOT']     = '{$translations['COM_AKEEBA_FILEFILTERS_LABEL_UIROOT']}';
    Solo.Transfer.translations['COM_AKEEBA_CONFIG_DIRECTFTP_TEST_FAIL']   = '{$translations['COM_AKEEBA_CONFIG_DIRECTFTP_TEST_FAIL']}';
    Solo.Transfer.translations['COM_AKEEBA_CONFIG_UI_BROWSE']             = '{$translations['COM_AKEEBA_CONFIG_UI_BROWSE']}';
    Solo.Transfer.translations['COM_AKEEBA_CONFIG_UI_CONFIG']             = '{$translations['COM_AKEEBA_CONFIG_UI_CONFIG']}';
    Solo.Transfer.translations['COM_AKEEBA_CONFIG_UI_REFRESH']            = '{$translations['COM_AKEEBA_CONFIG_UI_REFRESH']}';
    Solo.Transfer.translations['COM_AKEEBA_CONFIG_UI_FTPBROWSER_TITLE']   = '{$translations['COM_AKEEBA_CONFIG_UI_FTPBROWSER_TITLE']}';
    Solo.Transfer.translations['COM_AKEEBA_CONFIG_DIRECTFTP_TEST_OK']     = '{$translations['COM_AKEEBA_CONFIG_DIRECTFTP_TEST_OK']}';
    Solo.Transfer.translations['COM_AKEEBA_CONFIG_DIRECTSFTP_TEST_OK']    = '{$translations['COM_AKEEBA_CONFIG_DIRECTSFTP_TEST_OK']}';
    Solo.Transfer.translations['COM_AKEEBA_CONFIG_DIRECTSFTP_TEST_FAIL']  = '{$translations['COM_AKEEBA_CONFIG_DIRECTSFTP_TEST_FAIL']}';
