...
Akeeba Solo 2.3.2
================================================================================
(unreleased version number, reserved to keep versioning in sync with Akeeba Backup for WordPress)
...
# [HIGH] The "Replace main .htaccess with default" feature, enabled by default, causes the restoration of Joomla! sites to fail.
# [HIGH] The update feature was not working due to a Javascript error
# [MEDIUM] Debug mode was enabled by default
# [LOW] Two Factor Authentication is not disabled when you enable debug mode
...
# [LOW] CHANGELOG modal in main and update views does not display correctly [gh-86]
