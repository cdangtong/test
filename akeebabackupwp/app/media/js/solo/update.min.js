...
0);document.getElementById("extractProgressBarTextFile").innerText=a.lastfile;empty(a.factory)||(Solo.Update.factory=a.factory);a.done?window.setTimeout(Solo.Update.finalizeUpdate,500):(post={task:"stepRestore",factory:a.factory},Solo.System.doEncryptedAjax(post,function(a){Solo.Update.stepExtract(a)}))}};Solo.Update.finalizeUpdate=function(){Solo.System.doEncryptedAjax({task:"finalizeRestore",factory:Solo.Update.factory},function(a){window.location=Solo.Update.finaliseUrl})}; //# sourceMappingURL=update.min.map
