...
Solo.Restore.doAjax=function(a,b,d){json=JSON.stringify(a);a={json:json};0<Solo.Restore.password.length&&(a.password=Solo.Restore.password);var g=(new Date).getTime()/1E3,k=parseInt(g,10);a._cacheBustingJunk=Math.round(1E3*(g-k));Solo.Ajax.ajax({type:"POST",url:Solo.Restore.ajaxURL,cache:!1,data:a,timeout:6E5,success:function(a){var e=a.indexOf("###");if(-1==e)a="Invalid AJAX data: "+a,null==d?null!=Solo.Restore.errorCallback?Solo.Restore.errorCallback(a):Solo.Restore.errorCallbackDefault(a):d(a);
else{0!=e&&(a.substr(0,e),a=a.substr(e));a=a.substr(3);var e=a.lastIndexOf("###"),e=a=a.substr(0,e),f=null,c=null;try{c=JSON.parse(a)}catch(h){f=h}if(null!=f)try{c=JSON.parse(e),f=null}catch(h){}if(null!=f){errorMessage=f.message+"\n<br/>\n<pre>\n"+a+"\n</pre>";if(null!=d){d(errorMessage);return}if(null!=Solo.Restore.errorCallback){Solo.Restore.errorCallback(errorMessage);return}Solo.Restore.errorCallbackDefault(errorMessage)}b(c)}},error:function(a,b,f){f=a.responseText?a.responseText:"";var c="<strong>AJAX Loading Error</strong><br/>HTTP Status: "+
a.status+" ("+a.statusText+")<br/>",c=c+"Internal status: "+b+"<br/>XHR ReadyState: "+a.readyState+"<br/>",c=c+"Raw server response:<br/>"+Solo.System.sanitizeErrorMessage(f);null==d?null!=Solo.Restore.errorCallback?Solo.Restore.errorCallback(c):Solo.Restore.errorCallbackDefault(c):d(c)}})};
